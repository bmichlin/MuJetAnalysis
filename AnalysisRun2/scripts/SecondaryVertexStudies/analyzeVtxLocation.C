    ...
    for(int k=0; k<t->GetEntries(); k++) {
	  ...
	  // 	  ev_isVtxOK++;
	    ...
	    // 	    ev_is2MuJets++;
	      ...
	      cout << "genA0Mu0_vx "<< genA0Mu0_vx<<endl;
	      cout << "genA1Mu0_vx "<< genA1Mu0_vx<<endl;
	      
	      cout << "genA0Mu0_vy "<< genA0Mu0_vy<<endl;
	      cout << "genA1Mu0_vy "<< genA1Mu0_vy<<endl;
	      
	      cout << "genA0Mu0_vz "<< genA0Mu0_vz<<endl;
...
void analyzeVtxLocation()
{
  std::vector< std::vector<string> > DarkSUSY_mH_125_mGammaD_v;
  readTextFileWithSamples("AnaSamplesVertexStudies.txt", DarkSUSY_mH_125_mGammaD_v);
